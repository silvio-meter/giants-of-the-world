...
Fernando de Alva Ixtlilxochitl, a Nahua historian of the late sixteenth and early seventeenth century writing in Spanish, gives the fullest account of the Quinametzin within a scheme of world-ages.

Bernardino de Sahagun's Florentine Codex, compiled with Nahua informants in the sixteenth century, records related material on earlier peoples and on the building of Teotihuacan.

Diego Duran and other chroniclers mention giant bones and their interpretation. Later Mexican antiquarian writing carried the tradition forward.`,
    disputed: `How much of the recorded Quinametzin material is pre-conquest Nahua tradition and how much is colonial synthesis is not resolvable with confidence. Every substantial source was written after the conquest, mostly by or for Spanish readers, and often by authors explicitly reconciling indigenous history with the Bible.

The fossil evidence is straightforward on its own terms: the Valley of Mexico contains extensive Pleistocene megafauna remains, and mammoth bones were certainly among those exhibited as giants' bones. This explains the physical claims without requiring the tradition to be about anything other than what people found in the ground.

Whether Teotihuacan's builders were remembered at all in Nahua tradition is debated. The city's actual builders and their language remain uncertain, which is a live archaeological question independent of the giant material.

Modern pseudo-archaeological use of the Quinametzin, particularly in ancient-astronaut writing, has no support in the sources and should be disregarded.`,
    sources: [
      "Fernando de Alva Ixtlilxochitl, Relaciones and Historia de la nacion chichimeca (late 16th-early 17th c.)",
      "Bernardino de Sahagun, Florentine Codex (16th c.)",
      "Diego Duran, Historia de las Indias de Nueva Espana",
      "Pleistocene megafauna deposits, Valley of Mexico (physical context)",
    ],
  },
...
Pedro de los Rios, a Dominican, is associated with a widely reproduced version, and the account was carried into European scholarship by Alexander von Humboldt in the early nineteenth century, whose Vues des Cordilleres brought it to a wide readership and fixed the Babel comparison in print.

Ixtlilxochitl's world-age scheme provides the wider Quinametzin context.

The pyramid itself has been archaeologically investigated since the 1930s, with tunnelling revealing a long sequence of superimposed construction phases beginning well over two thousand years ago.`,
    disputed: `Whether the Xelhua story is substantially indigenous or substantially a colonial construction is the central unresolved question, and honest treatments say so. The Babel parallel is too close and the transmission history too compromised for confidence either way.

Humboldt's role deserves note: his enthusiasm for the parallel amplified it, and much later repetition traces to him rather than to any indigenous source.

The pyramid's actual construction history is well studied and has nothing to do with giants or with a single builder; it is a long accretion of successive structures by the region's inhabitants.
...
Emily Carr's paintings brought the figure to a settler Canadian audience in the early twentieth century, on her own terms rather than Kwakwaka'wakw ones.

Contemporary Kwakwaka'wakw carvers and writers are the authoritative living source, and museum holdings in Canada and abroad are subject to ongoing repatriation discussion.`,
    disputed: `The Boas-Hunt corpus is invaluable and also a product of salvage anthropology, collected under assumptions about vanishing cultures that were wrong, and organised according to external analytic categories. It should be read as a source with a viewpoint.

The potlatch was banned in Canada from 1885 to 1951, which disrupted transmission of exactly the contexts in which Dzunukwa masks functioned. Any account of "traditional" practice has to reckon with that suppression.

Comparisons drawn between Dzunukwa and Sasquatch or Bigfoot are common in popular writing and are misleading. She is a specific being within a specific cultural and ceremonial system, with ownership and inheritance attached; the cryptozoological framing strips all of that out.

We are describing this from outside. Kwakwaka'wakw sources should be preferred to ours.`,
    sources: [
      "Kwakwaka'wakw oral tradition and hereditary mask traditions",
      "Franz Boas with George Hunt, Kwakiutl ethnographic corpus (late 19th-early 20th c.)",
      "Contemporary Kwakwaka'wakw carvers and community sources",
    ],
  },

  "si-te-cah": {
    motifs: ["cannibal", "pre-people", "bones-as-proof"],
    open: "The Si-Te-Cah are red-haired giants said in a Northern Paiute account to have been driven into a cave and burned. Lovelock Cave in Nevada is a real archaeological site, and almost everything popularly claimed about it is wrong.",
    story: `The story as it is usually told runs like this: a hostile people, red-haired and of great size, warred with the Paiute until a coalition drove the last of them into a cave, piled brush at the entrance, and set it alight.

Lovelock Cave in Nevada is a genuine and important archaeological site. It was mined for guano in 1911, which destroyed a great deal of stratigraphy, and excavated afterwards. It produced an extraordinary quantity of Great Basin material, including duck decoys made of tule reed, dated to around two thousand years old and among the oldest known anywhere.

What it did not produce is giants. No skeleton of anomalous size has ever been documented from the site in any professional record. Hair recovered from burials can appear reddish, which happens to dark hair through oxidation and soil chemistry over long periods, and is a well-understood taphonomic effect rather than evidence of a red-haired population.

The giant claims trace largely to a 1931 newspaper report and to later popular writing, particularly Sarah Winnemucca Hopkins's 1883 memoir being read in ways it does not support. Winnemucca, a Northern Paiute writer and activist, recorded a tradition about an enemy people who were cannibals and who were destroyed in a cave. She does not describe them as giants.

That is the crux of this entry. There is a Paiute tradition. There is a real cave. And there is a modern accretion of giant claims, layered on by newspapers, hobbyist writers and later television, which has largely displaced both in public awareness.

The tradition deserves better than being used as evidence for something it never said.`,
    origins: `Sarah Winnemucca Hopkins, Life Among the Piutes (1883), records the tradition of an enemy people destroyed in a cave. It is the earliest published account and it is by a Northern Paiute author.

Lovelock Cave was excavated by L.L. Loud in 1912 and by Loud and M.R. Harrington in 1924; their report was published by the University of California in 1929. Subsequent work has continued through the twentieth century.

Newspaper coverage in the early twentieth century, notably in 1931, introduced or amplified the giant framing.

The claims were spread much further by later popular and fringe literature and by television treatments from the 2000s onward.`,
    disputed: `There is no professional archaeological documentation of giant remains from Lovelock Cave. Claims to the contrary rely on newspaper reports, secondhand accounts, and photographs that do not show what they are said to show.

The reddish hair is explained by post-depositional chemical change. This is not a contested point among specialists.
...
The site's real significance (the tule duck decoys, the Great Basin sequence) is regularly overshadowed by the giant claims, which is a loss.`,
    sources: [
      ...
      "Subsequent Great Basin archaeological literature",
    ],
  },
...
Judaculla Rock has been surveyed and studied archaeologically, with recording projects continuing; it is managed with Eastern Band involvement.

Place-names throughout the western North Carolina mountains preserve the tradition.`,
    disputed: `Mooney's corpus is foundational and also a nineteenth-century salvage ethnography, filtered through his selection, translation and framing. It is a starting point, not an authority over Cherokee sources.

The petroglyphs on Judaculla Rock have not been securely dated or interpreted. Estimates vary widely and there is no consensus on what the carvings represent; the association with Tsul'kalu is traditional attribution rather than an archaeological finding.

The etymology of the name and its relation to the anglicised Judaculla is discussed differently in different sources.

As with other entries here, this is described from outside a living tradition, and Cherokee accounts should take precedence over this one.`,
    sources: [
      "James Mooney, Myths of the Cherokee, BAE 19th Annual Report (1900)",
      "Cherokee oral tradition (Eastern Band; Cherokee Nation)",
      "Judaculla Rock petroglyph site, Jackson County, North Carolina",
    ],
  },
...
Defeat, where it happens, is usually by cleverness, by a shaman or person of power, or by the being's own excess.

A note on care: the closely related Algonquian figure sometimes called the wendigo has been heavily commercialised in horror fiction and film, generally with no reference to the traditions it comes from and frequently in ways Indigenous writers have objected to. This codex is not going to reproduce that treatment.`,
    origins: `Abenaki and wider Wabanaki oral tradition, including Penobscot, Passamaquoddy, Mi'kmaq and Maliseet material, with substantial variation between communities.

Nineteenth and early twentieth-century collection includes Charles G. Leland's Algonquin Legends of New England (1884) and Frank Speck's ethnographic work, both of which must be used with awareness of their period and method.

Contemporary Abenaki and Wabanaki writers and communities are the living and authoritative source. Joseph Bruchac, among others, has written extensively from within the tradition.

Related cannibal-giant traditions across the wider Algonquian-speaking world provide comparative context but are not interchangeable.`,
    disputed: `Terminology is a real problem. Names, spellings and the precise identity of these beings differ between languages and communities, and external sources have often collapsed distinct traditions into one label. Treating them as a single pan-Indigenous figure is an error.

Leland's collection in particular reworked material for a literary audience and is not a reliable transcription.

The extent to which these beings are understood as literal, as moral instruction, or as both is not a question outsiders can settle, and answers differ between communities.
...
The characterisations are apt in a way that reads as close observation. The north wind is a bear because it arrives with force and cold. The south wind is a fawn because it is mild and light. This is a weather system described through the temperaments of animals people knew well.
...
Arthur C. Parker, of Seneca descent, produced substantial ethnographic and folkloric work in the early twentieth century and is a more direct source for much Haudenosaunee material.

Contemporary Haudenosaunee sources, including community and Confederacy publications, are the authoritative reference.`,
    disputed: `Converse's collection was assembled by a sympathetic outsider and published after her death with editorial intervention. The tidy four-animal scheme as usually reproduced may owe something to that presentation, and the extent of variation across the Six Nations is flattened in most published versions.

Whether Gaoh should be described as a giant at all is questionable. He is a powerful being with a cosmological office; the giant framing is imported by collections like this one and is not native to the tradition. We have kept the entry because he is widely catalogued that way, and this is worth flagging rather than hiding.

The names, spellings and attributes vary between nations and between sources, and no single version should be treated as canonical.`,
    sources: [
      "Haudenosaunee oral tradition, Six Nations (variation between nations)",
      "Harriet Maxwell Converse, Myths and Legends of the New York State Iroquois (1908), ed. A.C. Parker",
      "Arthur C. Parker, Seneca ethnographic and folkloric writings, early 20th c.",
    ],
  },
};
